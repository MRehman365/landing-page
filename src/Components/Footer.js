    ...
    <footer className="bg-[#070707] text-white py-10 mt-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-[13px] mb-1 text-[#d4d4d4]">F02, D42 Red Fm Road Sector 2 Block D Noida, Uttar Pradesh 201301</p>
          <p className="text-[13px] mb-1 text-[#d4d4d4]">+91 8905054141</p>
          <p className="text-[13px] mb-1 text-[#d4d4d4]">support@maxifysolution.com</p>
        ...
        <div>
          ...
          <ul>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link to="/">App Development</Link></li>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link to="/">Web Development</Link></li>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link to="/">Digital Marketing</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-semibold mb-4">Explore</h3>
          <ul>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link href="#">About</Link></li>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link to="/">Projects</Link></li>
            <li className="text-[13px] mb-1 text-[#d4d4d4]"><Link to="/">Contact</Link></li>
          </ul>
        </div>
        <div>
